...
export const MENU_CATEGORIES: NavCategory[] = [
  ...
  },
  {
    ...
    items: [
      { screen: 'Community', name: 'Community Circle', desc: 'Peer reflections & AI companion', icon: 'people-outline', tag: 'CARE', pastelBg: '#E0F2FE', iconColor: '#0284C7' },
...
export function AppHeader({ navigation, title }: { navigation: any; title?: string }) {
  ...
  const handleNavigate = (screenName: string) => {
    setMenuOpen(false);
    const stackScreens = ['Journal', 'Games', 'Memes', 'Books', 'Music', 'Contact', 'Community', 'HomeMain'];
    try {
            ...
            <View style={modalStyles.header}>
              <View style={modalStyles.headerTitleRow}>
                <View style={modalStyles.headerIcon}>
                  <Image
                    source={require('../../public/logo.jpeg')}
                    style={modalStyles.headerLogoImg}
                    resizeMode="cover"
                  />
                </View>
                <View>
