...
![Moodverse Banner](public/logo.jpeg)
...
[![React Native](https://img.shields.io/badge/React_Native-Expo_57-0284C7?style=for-the-badge&logo=expo&logoColor=white)](https://expo.dev/)
...
```mermaid
graph TD
    A[Moodverse Sanctuary] --> B[Core Wellbeing & AI]
    A --> C[Immersive Relaxation & Sensory]
    A --> D[Cognitive Therapy & Analytics]
    A --> E[Community & Crisis Care]

    B --> B1[AI Facial Emotion Scanner]
    B --> B2[Personalized AI Companion]
    B --> B3[Restorative Yoga & Breathwork]

    C --> C1[3D VR Relaxation Rooms]
    C --> C2[Procedural Web Audio Engine]
    C --> C3[Sensory Zen Sand Garden & Games]

    D --> D1[5-4-3-2-1 Sensory Grounding]
    D --> D2[CBT Thought Restructuring]
    D --> D3[Progressive Muscle Relaxation]
    D --> D4[Mindfulness Analytics Dashboard]

    E --> E1[Compassionate Community Circle]
    E --> E2[Encrypted Daily Gratitude Journal]
    E --> E3[24/7 Lifeline & Emergency 988]
```
